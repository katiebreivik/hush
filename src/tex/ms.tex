...
\begin{table}[]
    ...
    \begin{tabular}{|c|c|c|c|c|c|c|}
       \hline
       parameter variation & model & a & b & c & d & e \\
       \hline
       \hline
       fiducial & F50 & -217.8 & -183.9 & -74.5 & -13.7 & -0.94452821 \\
       \hline
...
\snotes{For our simulations with parameter variations, we see an interplay of the physics of binary evolution with the skews introduced by the metallicity-dependent orbital period distribution/binary fraction. We will summarize how the formation efficiency of each DWD type is impacted by the parameter variations. Of note in this analysis is that a) the log-normal metallicity-dependent ZAMS orbital period distribution increasingly skews towards orbital periods below $10^4$ days for decreasing metallicity. However, b) the log-uniform P$_{\rm{orb}}$ distribution of F50 produces a higher number of the shortest orbital period systems (below $\sim 100$ days) than for FZ as the tails of the FZ distribution fall quickly below this threshold.} 
